...
/*Intent launch = getIntent();
        ...
        if (topic.equals("Math")){
            if (ans == 1) {
                ...
                user_ans.setText("You put: " + "'If the starting numbers of coins are random, then the player who goes first will\n" +
                        "most likely win,'");
                correct_ans.setText("Correct Answer: " + "'If the starting numbers of coins are random, then the player who goes first will\n" +
                        "most likely win,'");
                total_num.setText("1/1 correct. \n" + "You're basically Archimedes");
            } else if (ans == 2) {
